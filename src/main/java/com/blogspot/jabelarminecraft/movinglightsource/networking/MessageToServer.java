...
package com.blogspot.jabelarminecraft.movinglightsource.networking;
...
public class MessageToServer implements IMessage 
{
    ...
    public static class Handler implements IMessageHandler<MessageToServer, IMessage> 
    {
        ...
        {
            // DEBUG
            System.out.println(String.format("Received %s from %s", message.text, MovingLightSource.proxy.getPlayerEntityFromContext(ctx).getDisplayName()));
            // Know it will be on the server so make it thread-safe
            final EntityPlayerMP thePlayer = (EntityPlayerMP) MovingLightSource.proxy.getPlayerEntityFromContext(ctx);
