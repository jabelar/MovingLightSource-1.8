 ...
 *
 */
public class TileEntityCompactor extends TileEntityLockable implements IUpdatePlayerListBox, ISidedInventory
{
    // enumerate the slots
    ...
    private ItemStack[] compactorItemStackArray = new ItemStack[2];
    ...
    private int currentItemCompactTime;
