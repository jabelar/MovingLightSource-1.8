...
package com.blogspot.jabelarminecraft.blocksmith.structures;
...
import com.blogspot.jabelarminecraft.blocksmith.WorldData;
...
public class Structure implements IStructure
{
	...
	public void generateTick(TileEntity parEntity, int parOffsetX, int parOffsetY, int parOffsetZ) 
	{
		...
		// exit if finished
		if (WorldData.get(theWorld).getHasCastleSpwaned())
		{
			// DEBUG
...
//		else if (!finishedGeneratingBasic)
		...
		else
		{
			...
			WorldData.get(theWorld).setHasCastleSpawned(true);
		}
	}
