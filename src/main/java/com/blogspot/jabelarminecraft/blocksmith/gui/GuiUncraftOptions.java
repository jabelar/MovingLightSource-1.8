...
public class GuiUncraftOptions extends GuiScreen implements ISlider
{
	...
	public void initGui()
    {
        ...
        minLevel = new GuiSlider(2, width / 2 - 250 / 2 - 150 / 2, 175, 150, 20, "Min Level: ", "", 0, 50, BlockSmith.instance.minLvlServer, true, true, this);
        minLevel.precision = 0;
        maxLevel = new GuiSlider(3, width / 2 + 250 / 2 - 150 + 150 / 2, 175, 150, 20, "Max Level: ", "", 0, 50, BlockSmith.instance.maxLvlServer, true, true, this);
	...
	public void actionPerformed(GuiButton button)
    {
        if(button.id == 0)
        {
            BlockSmith.uncraftMethod = 0;
            BlockSmith.saveProperties();
        }
        else if(button.id == 1)
        {
            BlockSmith.uncraftMethod = 1;
            BlockSmith.saveProperties();
        }
    }
    ...
    public void onChangeSliderValue(GuiSlider slider)
    {
        ...
        BlockSmith.minLvlServer = minLevel.getValueInt();
        BlockSmith.maxLvlServer = maxLevel.getValueInt();
    }
}
