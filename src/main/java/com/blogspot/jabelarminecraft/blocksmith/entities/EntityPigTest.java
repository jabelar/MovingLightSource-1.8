...
package com.blogspot.jabelarminecraft.blocksmith.entities;
	...
	public boolean attackEntityFrom(DamageSource parDamageSource, float parDamageAmount)
	{
        ...
        else
        {
            ...
            else
            {
                ...
                else if (parDamageSource.isFireDamage() && this.isPotionActive(Potion.fireResistance))
                {
                	// DEBUG
                ...
                {
                    if ((parDamageSource == DamageSource.anvil || parDamageSource == DamageSource.fallingBlock) && this.getEquipmentInSlot(4) != null)
                    {
                    	// DEBUG
                    	System.out.println("Attacked by falling block without a helmet");
                        this.getEquipmentInSlot(4).damageItem((int)(parDamageAmount * 4.0F + this.rand.nextFloat() * parDamageAmount * 2.0F), this);
